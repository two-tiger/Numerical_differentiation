...
{
    Complex a, b, c;
    a = ComplexMul(ComplexSin(x->complexEntry[0]), x->complexEntry[2]);
...
int main(void)
{
    ...
    printf("\n");
    NdsclaFunction *fun1 = NdsclaFunctionAlloc(f2, 3);
    fun1->complexfunction = f2complex;
